...
[![Build Status](https://img.shields.io/travis/ozankurt/laravel-mysql-spatial.svg?style=flat-square)](https://travis-ci.org/ozankurt/laravel-mysql-spatial)
[![Code Climate](https://img.shields.io/codeclimate/maintainability/ozankurt/laravel-mysql-spatial.svg?style=flat-square)](https://codeclimate.com/github/ozankurt/laravel-mysql-spatial/maintainability)
[![Code Climate](https://img.shields.io/codeclimate/c/ozankurt/laravel-mysql-spatial.svg?style=flat-square&colorB=4BCA2A)](https://codeclimate.com/github/ozankurt/laravel-mysql-spatial/test_coverage) [![Packagist](https://img.shields.io/packagist/v/ozankurt/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/ozankurt/laravel-mysql-spatial)
[![Packagist](https://img.shields.io/packagist/dt/ozankurt/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/ozankurt/laravel-mysql-spatial) [![StyleCI](https://github.styleci.io/repos/83766141/shield?branch=master)](https://github.styleci.io/repos/83766141)
...
```sh
$ composer require ozankurt/laravel-mysql-spatial:^4.0

# or for Laravel version < 8.0
$ composer require ozankurt/laravel-mysql-spatial:^3.0
```

For MySQL 5.7:

```shell
$ composer require ozankurt/laravel-mysql-spatial:^2.0
```

For MySQL 5.6 and 5.5:

```shell
$ composer require ozankurt/laravel-mysql-spatial:^1.0
```
...
'providers' => [
   ...
   */
  Kurt\LaravelMysqlSpatial\SpatialServiceProvider::class,
],
```
...
Then edit the migration you just created by adding at least one spatial data field. For Laravel versions prior to 5.5, you can use the Blueprint provided by this package (Kurt\LaravelMysqlSpatial\Schema\Blueprint):
 ...
 * @property \Kurt\LaravelMysqlSpatial\Types\Polygon $area
 */
...
| Kurt\LaravelMysqlSpatial\Types                             | OpenGIS Class                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
In order for your Eloquent Model to handle the Geometry classes, it must use the `Kurt\LaravelMysqlSpatial\Eloquent\SpatialTrait` trait and define a `protected` property `$spatialFields`  as an array of MySQL Spatial Data Type column names (example in [Quickstart](#user-content-create-a-model)).
...
For Laravel versions prior to 5.5, you can use the Blueprint provided with this package: `Kurt\LaravelMysqlSpatial\Schema\Blueprint`.
