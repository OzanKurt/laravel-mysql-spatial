...
use Kurt\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException;
use Kurt\LaravelMysqlSpatial\Tests\Integration\Eloquent\TestModel;
...
class SpatialTraitTest extends IntegrationBaseCase
{
    ...
    public function testInsertUpdateLineStringHasCorrectSql()
    {
        ...
        $this->model->linestring = new \Kurt\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdatePolygonHasCorrectSql()
    {
        ...
        $polygon = new \Kurt\LaravelMysqlSpatial\Types\Polygon([
            new \Kurt\LaravelMysqlSpatial\Types\LineString([$point1, $point2, $point3, $point4, $point1]),
        ]);
    ...
    public function testInsertUpdateMultiPointHasCorrectSql()
    {
        ...
        $this->model->multipoint = new \Kurt\LaravelMysqlSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiLineStringHasCorrectSql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Kurt\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $linestring2 = new \Kurt\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);

        $this->assertFalse($this->model->exists);

        $this->model->multilinestring = new \Kurt\LaravelMysqlSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPolygonHasCorrectSql()
    {
        ...
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $polygon1 = new \Kurt\LaravelMysqlSpatial\Types\Polygon([
            new \Kurt\LaravelMysqlSpatial\Types\LineString([$point1, $point2, $point3, $point1]),
        ]);
        ...
        $polygon2 = new \Kurt\LaravelMysqlSpatial\Types\Polygon([
            new \Kurt\LaravelMysqlSpatial\Types\LineString([$point5, $point6, $point7, $point5]),
        ]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Kurt\LaravelMysqlSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function testInsertUpdateGeometryCollectionHasCorrectSql()
    {
        ...
        $linestring1 = new \Kurt\LaravelMysqlSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Kurt\LaravelMysqlSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
    ...
    public function testScopeDistance()
    {
        ...
        $this->assertInstanceOf(\Kurt\LaravelMysqlSpatial\Eloquent\Builder::class, $query);
        $q = $query->getQuery();
    ...
    private function buildTestPolygon()
    {
        ...
        $linestring3 = new \Kurt\LaravelMysqlSpatial\Types\LineString([$point5, $point6]);

        return new \Kurt\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2, $linestring3]);
    }
    ...
    public function testScopeOrderBySpatialThrowsExceptionWhenFunctionNotRegistered()
    {
        $point = new Point(1, 2);
        $this->assertException(
            \Kurt\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class,
            'does-not-exist'
        );
